            ...
            <div>
              <div className='card'>
                ...
                <p className='no-margin'>
                  This is used to link control info and evidence across workspaces.
                  <button className='btn btn-border btn-small mg-left-10'>Link workspaces</button>
                </p>
              ...
              <div className='card'>
                <h2>
                  REQUIRED APPROVALS
                  <button className='float-right btn btn-border btn-small'>Set up</button>
                </h2>
                <p>
                  Set up a process so readiness for this control will require specific people to
                  approve it. <a href=''>Learn about required approvals</a>
                </p>
              </div>
              <hr />
              <div className='card'>
                <h2>
                  TASKS{' '}
                  <button className='float-right btn btn-border btn-small'>Create task</button>
                </h2>
                    ...
                    >
                      <div>
                        <p>
                          ...
                          {item.version}{' '}
                          <span className='ms-4 text-white initial' style={{lineHeight: 'normal'}}>
                            {' '}
                            {item.count}
                          </span>
                        </p>
