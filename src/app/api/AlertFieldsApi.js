...
const AlertFieldDetailsUrl = "http://10.41.3.232:501/api/LDPlattform/v1/AlertFields/Details"

export const fetchAlertFieldDetailsUrl = async (id) => {
  try {
    const response = await FetchWithToken(`${AlertFieldDetailsUrl}?id=${id}`, {
      method: 'GET',
      headers: {
