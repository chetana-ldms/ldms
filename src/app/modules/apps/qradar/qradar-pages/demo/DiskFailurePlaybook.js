...
import {dndinitialNodes as initialNodes, edges as initialEdges} from './initial-elementsDiskFailure'
...
export const DiskFailurePlaybook = () => {
              ...
              <div className='col'>
               ...
               {/* <div
                ...
                <div
                  ...
                  onDragStart={(event) => onDragStart(event, ' Healthcheck')} //smart-ctl healthcheck
                  draggable
                >
                ...
                <div
                  className='btn btn2 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'Review logs')} //review system logs
                  draggable
                >
                ...
                <div
                  className='btn btn6 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'Disc Operation')} //review system logs
                  draggable
                >
                  <span> Disc operation </span>
                </div>
 
                {/* <div
                  className='btn btn3 btn-sm mb-1 dndnode'
                  onDragStart={(event) =>
                    onDragStart(event, 'Check for recent hardware changes or disk detachment')
                  }
                  draggable
                >
                  <span> Check for recent hardware changes or disk detachment</span>
                </div>
               
                <div
                  className='btn btn4 btn-sm mb-1 dndnode'
                  onDragStart={(event) =>
                    onDragStart(event, 'df -h - Verify disc space and mount status')
                  }
                  draggable
                >
                  <span> df -h - Verify disc space and mount status</span>
                </div>
                <div
                  className='btn btn5 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'Backup')}
                  draggable
                >
                  <span> Backup</span>
                </div>
                <div
                  className='btn btn6 btn-sm mb-1 dndnode'
                  onDragStart={(event) =>
                    onDragStart(event, 'Replace the faulty disk or remount if temporary failure')
                  }
                  draggable
                >
                  <span> Replace the faulty disk or remount if temporary failure</span>
                </div>
