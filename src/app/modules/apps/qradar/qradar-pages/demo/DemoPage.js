        ...
        <div className='card mb-8'>
          ...
          <div className='card-body'>
            <div className='demo-block'>
              <p className=''>
                Add Memory Spike alert — triggered when system memory usage exceeds safe thresholds
                or OOM kill events occur.
              </p>
              <button className='btn btn-new' onClick={() => addalerttolocal(datatoBeadded[10])}>
          ...
          <div className='col-lg-6'>
            <div className='card mb-5'>
              ...
              <div className='card-body'>
                <div className='demo-block'>
                  <p className=''>
                    Add Network Outage alert — triggered by NIC down events, ICMP failures, or
                    dropped outbound traffic
                  </p>
                  <button
                    className='btn btn-new'
                    onClick={() => addalerttolocal(datatoBeadded[12])}
                  >
