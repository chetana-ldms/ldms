          ...
          <div className='card-toolbar'>
            <div className='d-flex align-items-center gap-2 gap-lg-3'>
              <a
                ...
                className='btn btn-sm fw-bold btn-primary fs-14 btn-new'
              >
                Create Incident
              </a>
              <div className='m-0'>
                ...
                >
                  ...
                  <div className='px-7 py-5'>
                    ...
                    <div className='d-flex justify-content-end'>
                      <button
                        type='reset'
                        className='btn btn-sm btn-light btn-active-light-primary me-2 fs-14'
                ...
                {alertData.map((item, index) => (
                  <>
                    <tr>
                      ...
                      >
                        <span className='text-hover-primary d-block mb-1 fs-8'>-1d 3h 43m</span>
                      </td>
                      <td>
                      ...
                      <td className='text-dark text-hover-primary fs-8'>User {item.id}</td>
