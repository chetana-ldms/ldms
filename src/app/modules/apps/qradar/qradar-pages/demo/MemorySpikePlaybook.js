            ...
            <div className='card-body bg-heading pad-10'>
              <div className='col'>
                ...
                <div
                  ...
                  onDragStart={(event) => onDragStart(event, 'Task Manager - High memory consuming process')}
                  draggable
                >
                  <span> Task Manager - High memory consuming process</span>
                </div>
                <div
                ...
                <div
                  className='btn btn1 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'Review logs')}
                  draggable
                >
                ...
                <div
                  className='btn btn2 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'Restart the process')}
                  draggable
                >
                ...
                <div
                  className='btn btn3 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'Review logs for memory leaks or app errors')}
                  draggable
                >
                  <span>Review logs for memory leaks or app errors</span>
                </div>
               {/* <div
                  className='btn btn4 btn-sm mb-1 dndnode'
                ...
                >
                  ...
                  <div
                  className='btn btn5 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'Memory usage ')}
                  draggable
                >
