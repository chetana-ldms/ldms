            ...
            <div className='card-body bg-heading pad-10'>
              <div className='col'>
                ...
                <div
                  ...
                  onDragStart={(event) =>
                    onDragStart(event, 'Ping - Ping the affected host from another system')
                  }
                  draggable
                >
                  <span>Ping - Ping the affected host from another system</span>
                </div>
                <div
                ...
                <div
                  className='btn btn1 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'Ip - interface status')}
                  draggable
                >
                  <span>Ip - interface status</span>
                </div>
                <div
                  className='btn btn2 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'systemctl - Restart network service')}
                  draggable
                >
                  <span>systemctl - Restart network service</span>
                </div>
                <div
                  className='btn btn3 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'Validate switch/router port status')}
                  draggable
                >
                  <span>Validate switch/router port status</span>
                </div>
                <div
                  className='btn btn4 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'Review logs - firewall or routing changes')}
                  draggable
                >
                  <span>Review logs - firewall or routing changes</span>
                </div>
                <div
                  className='btn btn5 btn-sm mb-1 dndnode'
                  onDragStart={(event) => onDragStart(event, 'Ping - Verify')}
                  draggable
                >
