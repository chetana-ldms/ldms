  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response?.isSuccess) {
        ...
        navigate('/qradar/connection-types')
      } else {
    ...
    <div className='card config'>
      ...
      <div className='card-header bg-heading'>
        ...
        <div className='card-toolbar'>
          <Link to='/qradar/connection-types' className='white fs-15 text-underline'>
        ...
        <div className='card-body px-5 py-5'>
          ...
          <div className='row g-3 mb-4'>
            ...
            <div className='col-md-4 d-flex align-items-center'>
              <div className='form-check form-check-custom form-check-solid mt-6'>
                <input
                  ...
                  onChange={handleChange}
                />
                <label className='form-check-label small fw-bold ms-3' htmlFor='isSystem'>
                  Is System
                </label>
              </div>
            </div>
