                ...
                >
                  {AnalystVerdictDropDown && (
                    <div className='px-5 py-5'>
                      ...
                      <div className='text-right'>
                        <button className='btn btn-primary' onClick={handleSubmitAnalystVerdict}>
                          {' '}
                          Submit{' '}
                        </button>
                      </div>
                                ...
                                >
                                      ...
                                      <div className='row'>
                                        <div className='col-md-1 py-4 text-center'>
                                          <i
                                            ...
                                            style={{fontSize: '2rem', width: '2em', height: '2em'}}
                                          ></i>
                                        </div>
                                        <div className='col-md-8'>
                                          <div className='d-flex '>
                                            <div className='border-right px-1'>
                                              {' '}
                                              <span className='fs-8'>Threat status :</span>{' '}
                                              {threatHeaderDtls.threatStatus}
                                            </div>
                                            <div className='border-right px-1'>
                                              <span className='fs-8'>AI Confidence level : </span>
                                          ...
                                          />
                                          <div>
                                            <span className='fs-8'>Mitigation Actions Taken :</span>
                                  ...
                                  <div className="row">
                                    ...
                                    <div className="col-md-4">
                                      ...
                                      <hr
                                        className='my-1'
                                        style={{borderColor: '#3838a0', borderWidth: '7px'}}
                                      />
