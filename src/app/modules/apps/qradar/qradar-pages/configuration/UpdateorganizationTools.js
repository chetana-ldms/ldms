  ...
  const handleAction = (event) => {
    ...
    if (isEditing) {
      ...
      const existingItem = tableData.find(
        (item) => item.toolAction === selectedToolAction && item.apiUrl === enteredApiUrl
      )
      if (!existingItem) {
        const newToolAction = {
          toolAction: selectedToolAction,
          ...
          <div className='row mb-6 table-filter'>
            ...
            <div className='card-body pad-10 mt-5'>
              <div className='row mb-6'>
                ...
                <div className='col-lg-4 mb-4 mb-lg-0 d-flex align-items-end justify-content-start'>
                  <button className='btn btn-green btn-small' onClick={handleAction}>
            ...
            {tableData.length > 0 && (
              <div className='card-body border-top pad-10'>
                <h4>
                  List of Tool Actions({filteredList.length} / {filteredList.length})
                </h4>
