        ...
        {selectedValue == 'Path' && (
          <div className='row mt-5'>
            ...
            <div>
              ...
              {error && (
                <p className='no-margin red'>You must select one or more Exclusion Function</p>
              )}
            </div>
            <hr />
            <div>
                ...
                <div className='accordion-content'>
                  <div>
                    <div>
                      ...
                      />
                      <label htmlFor='suppressAlerts'>Suppress Alerts</label>
                      {selectedOption === 'suppressAlerts' && (
                        <>
                          <label className='semi-bold me-2'>Engines:</label>
                          <Dropdown isOpen={isCustomDropdownOpen} toggle={toggleCustomDropdown}>
                            <DropdownToggle className='btn btn-small btn-border'>
                              {customSelectedValue} <i className='fa fa-chevron-down' />
                            </DropdownToggle>
                            <DropdownMenu className='w-auto'>
                              <DropdownItem
                                onClick={() => handleCustomDropdownItemClick('Static AI')}
                              ...
                              <DropdownItem
                                onClick={() => handleCustomDropdownItemClick('Dynamic AI')}
                              >
                                <h6>Dynamic AI</h6>
                                <div>
                              ...
                              <DropdownItem
                                onClick={() => handleCustomDropdownItemClick('All engines')}
                              >
                                <h6>All engines</h6>
                      ...
                      <p>Do not display alerts on processes.</p>
                    </div>
                    <div>
                      <input
                        type='radio'
                      ...
                      <p>Reduce the monitoring level on the processes.</p>
                      <p>Usage example: to solve interoperability.</p>
                      <p>Important: lowers protection.</p>
                    </div>
                    <div>
                      <input
                        type='radio'
                        ...
                        onChange={handleOptionChange}
                      />
                      <label htmlFor='interoperabilityExtended'>Interoperability - extended</label>
                      <p>
                    ...
                    <div>
                      <input
                        ...
                        onChange={handleOptionChange}
                      />
                      <label htmlFor='performanceFocus'>Performance Focus</label>
                      <p>Disable monitoring of the processes.</p>
                      <p>Usage example: to solve performance issues related to these processes.</p>
                      <p>Important: Significantly lowers protection.</p>
                    </div>
                    <div>
                      <input
                        type='radio'
                        ...
                        onChange={handleOptionChange}
                      />
                      <label htmlFor='performanceFocusExtended'>Performance Focus - extended</label>
                      <p>Disable monitoring of the processes, and their child-processes.</p>
                      <p>Usage example: to solve performance issues related to these processes.</p>
                      <p>Important: Significantly lowers protection.</p>
                    </div>
                  </div>
