        ...
        <div className="col-md-7">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p>
                this only applies when the static AI detection engine is on. add
                the proytection mode of Malicious Threats is set to protect.{" "}
              </p>
              <input className="" type="checkbox" />
              <label>
                Remove malicious Macros from the office file instead of placing
                the files in quarantine
              </label>
              <hr />
              <div>
                <span>
            ...
            <div className="card-body pad-10">
              ...
              <div className="form-check form-switch">
                <input
                  ...
                  onChange={() =>
                    setUnwantedApplicationsChecked(!unwantedApplicationsChecked)
                  }
                />
                <label
                  className="form-check-label"
              ...
              <div className="form-check form-switch">
                <input
                  ...
                  onChange={() =>
                    setApplicationControlsChecked(!applicationControlsChecked)
                  }
                />
                <label
                  className="form-check-label"
      ...
      <div className="row mt-5">
        <div className="col-lg-12">
          <div className="card">
            <p className="pad-10">
              <i className="fa fa-circle-exclamation incident-icon blue mg0right-5" />{" "}
              Some agent Ui settings are supported for the agent version 21.7+
            </p>
          </div>
        </div>
      </div>
