            ...
            <div className='col-md-7'>
              <div className='card'>
                ...
                <div className='card-body pad-10'>
                  ...
                  <p>
                    This only applies when the static AI detection engine is on. Add the protection
                ...
                <div className='card-body pad-10'>
                  ...
                  <div className='form-check form-switch'>
                    <input
                      ...
                      onChange={() => handleDetectionEngineChange('staticAiSuspicious')}
                    />
                  ...
                  <div className='form-check form-switch'>
                    <input
                      ...
                      onChange={() => handleDetectionEngineChange('documentScript')}
                    />
                  ...
                  <div className='form-check form-switch'>
                    <input
                      ...
                      onChange={() => handleDetectionEngineChange('unwantedApplications')}
                    />
                  ...
                  <div className='form-check form-switch'>
                    <input
                      ...
                      onChange={() => handleDetectionEngineChange('alternativeThreats')}
                    />
