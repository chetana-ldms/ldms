...
import {
  fetchExclusionItemsImportReportUrl,
  fetchExclusionItemsImportUrl,
} from '../../../../../api/SentinalApi'
import {notify, notifyFail} from '../components/notification/Notification'

const ExclusionsImportPopUp = ({show, onClose, refreshParent}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetchExclusionItemsImportUrl(formData)
  ...
  const handleDownloadReport = async () => {
    try {
      ...
      const response = await fetchExclusionItemsImportReportUrl(data)
    ...
    <Modal show={show} onHide={handleClose} className='application-modal'>
      ...
      <Modal.Body>
        ...
        <div className='mt-5 pt-3'>
          <p>
            Upload a CSV file with a list of exclusion entries{' '}
          ...
          {importSuccess && !reportId && (
            <div className='mt-4 text-center'>
              ...
              <div className='mt-3'>
                ...
                <h5> Exclusions entries imported successfully.</h5>
              </div>
            </div>
          )}
...
export default ExclusionsImportPopUp
