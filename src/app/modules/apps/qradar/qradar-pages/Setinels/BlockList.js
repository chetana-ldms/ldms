            ...
            <div className="col-lg-6 d-flex">
              ...
              >
                ...
                <DropdownMenu className="w-auto px-5">
                  <label className="dropdown-checkbox d-flex">
                    <input
                      type="checkbox"
              ...
              <button className="btn btn-new btn-small" onClick={openPopup}>
                Add New
              </button>
              {showPopup && (
                <BlockListPopUp show={openPopup} onClose={closePopup} />
              )}
              <div className="float-left mg-left-10">
                <button className="btn btn-new btn-small">
                  Delete selection
                </button>
              </div>
            </div>
