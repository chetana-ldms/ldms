...
import {fetchMessagePlaceHolderGroupDeleteUrl, fetchMessagePlaceHolderGroupsUrl, fetchMessageTemplateGroupDeleteUrl, fetchMessageTemplateGroupsUrl, fetchMessageTemplateTypeDeleteUrl, fetchMessageTemplateTypesUrl} from '../../../../../../api/MessageTemplateApi'
...
const PlaceholderGroups = () => {
  ...
  const confirmDelete = async () => {
    if (itemToDelete) {
      ...
      try {
        const response = await fetchMessagePlaceHolderGroupDeleteUrl(data)
  ...
  const reload = async () => {
    try {
      setLoading(true)
      const response = await fetchMessagePlaceHolderGroupsUrl(0)
  ...
  const handleNavigateToUpdate = (id) => {
    navigate(`/qradar/placeholder-groups/update/${id}`, {state: {save: true}})
  }
  return (
      ...
      <div className='card-header no-pad'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>
            Placeholder Group ({currentItems ? currentItems.length : 0} /{' '}
        ...
        <div className='card-toolbar'>
          <div className='d-flex align-items-center gap-2 gap-lg-3'>
            <Link
              to='/qradar/placeholder-groups/add'
                    ...
                    {isActionAuthorized('Update') ? (
                      <span>
                        <Link
                          ...
                          to={`/qradar/placeholder-groups/update/${item.masterId}`}
                          title='Edit'
                        >
