...
const ControlsTracking = () => {
  ...
  const handleExportCSV = () => {
    ...
    const headers = ['Control Code', 'Control Name', 'Domain', 'Status']
  ...
  const domainOptions = Array.from(new Set(controls.map((item) => item.domainName).filter(Boolean)))
  ...
  const selectedDomainOption = domainOptions.find((option) => option.value === domainFilter) || null
      ...
      <div className='card p-2'>
        <div className='row mb-3 align-items-start'>
          <div className='col-md-6'>
            ...
            <div className='card-toolbar d-flex justify-content-start align-items-center gap-2 gap-lg-3'>
              <button
          ...
          <div className='col-md-6'>
            <div className='card-title header-filter'>
              ...
              <div className='d-flex align-items-center gap-3'>
                ...
                <select
                  className='form-select form-select-sm w-300px'
                  value={statusFilter}
