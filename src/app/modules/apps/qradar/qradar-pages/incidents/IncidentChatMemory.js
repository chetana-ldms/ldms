      ...
      <div className='d-flex'>
        ...
        <div className='ms-5'>
          <p className='fs-5 fw-bolder text-blue mb-2'>
            ...
            <span className='sub-txt text-gray float-right'>
              {' '}
              {getTimeAfterSeconds(fixedTime, 4)}
            </span>
          </p>
    ...
    <div className='d-flex flex-stack py-4' ref={message_3}>
      <div className='d-flex'>
        ...
        <div className='ms-5'>
          ...
          <p className=''>
            Trying to establish SSH connection to `admin@10.0.0.25` on port `22`...
          </p>
        </div>
      </div>
    </div>
    ...
    <div className='d-flex flex-stack py-4' ref={message_4}>
      <div className='d-flex'>
        ...
        <div className='ms-5'>
          ...
          <p className='fs-14'>SSH authentication successful using service account key</p>
        </div>
      </div>
    </div>
  )
    ...
    <div className='d-flex flex-stack py-4' ref={message_4}>
      <div className='d-flex'>
        ...
        <div className='ms-5'>
          ...
          <p className='fs-14'>Executing remote command</p>
          <p className='fs-14'>kill -9 12345</p>
        </div>
      </div>
    </div>
  )
      ...
      <div className='d-flex'>
        ...
        <div className='ms-5'>
          <p className='fs-5 fw-bolder text-blue mb-2'>
            ...
            <span className='sub-txt text-gray float-right'>
              {' '}
              {getTimeAfterSeconds(fixedTime, 12)}
            </span>
          </p>
          <p className='fs-14'>Command executed successfully</p>
          <p className='fs-14'>Result:** Process `12345` (Java) terminated.</p>
        </div>
      </div>
    </div>
  )
    ...
    <div className='d-flex flex-stack py-4' ref={message_4}>
      <div className='d-flex'>
        ...
        <div className='ms-5'>
          ...
          <p className='fs-14'>Running validation check (`free -m`) to confirm memory release</p>
        </div>
      </div>
    </div>
  )
      ...
      <div className='d-flex'>
        ...
        <div className='ms-5'>
          <p className='fs-5 fw-bolder text-blue mb-2'>
            ...
            <span className='sub-txt text-gray float-right'>
              {' '}
              {getTimeAfterSeconds(fixedTime, 16)}
            </span>
          </p>
          <p className='fs-14'>Memory usage dropped from 91% → 56%</p>
          <p className='fs-14'>
            Remote action completed. Resolution steps logged and report will be generated.*
          </p>
          <p>Completed The Task and Closed the Incident</p>
