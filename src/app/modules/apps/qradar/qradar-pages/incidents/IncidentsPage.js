  ...
  const getReplyMessage = async () => {
    try {
      ...
      if (storedMessageId && replyContent === storedMessageId) {
        ...
        if (replyContent.content.toLowerCase() === 'Received message and confirmed login attempt') {
          setIsShown(true)
        }
      }
    } catch (error) {
                      ...
                      <div>
                        ...
                        >
                          <div className='row'>
                            ...
                            <div className='text-dark col-md-9'>
                              <a href='#' className='text-dark'>
                                <span className='fw-bold'>Multiple Failed login Alert</span>
                              </a>
                            </div>
                          </div>
                          <div className='row'>
                          ...
                          <div className='d-flex justify-content-between bd-highlight mt-2'>
                            <div className='p-1 bd-highlight fs-14'>User2</div>
                            <div className='p-1 bd-highlight'>
                        ...
                        {incidentdata === null ? (
                          ...
                          incidentdata.map((item, index) => (
                            <>
                              <div className='incident-section' onClick={handleClick}>
                                <div className='row'>
                                  <div className='col-md-1'>
                                    <i className='fa-solid fa-arrow-up text-danger'></i>
                                  </div>
