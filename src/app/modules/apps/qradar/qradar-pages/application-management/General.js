        ...
        <div className='col-lg-12'>
          <table className='table'>
            ...
            <tr>
              ...
              <td>
                {general?.scanStatus === 'finished'
                  ? 'Completed'
                  : general?.scanStatus === 'aborted'
                  ? 'Aborted'
                  : general?.scanStatus === 'started'
                  ? 'In Progress'
                  : general?.scanStatus === 'none'
                  ? ''
                  : ''}{' '}
                ({getCurrentTimeZone(general?.fullDiskScanLastUpdatedAt)})
              </td>
            </tr>
            <tr>
